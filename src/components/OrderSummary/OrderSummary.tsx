    ...
    <div className={styles.OrdersSummary}>
      ...
      <div className={styles.OrdersSummary__grid}>
        ...
        <div className={styles.OrdersSummary__item}>
          ...
          <p className={styles.OrdersSummary__value} data-testid="totalValue">${summary.totalValue.toFixed(2)}</p>
        </div>
        <div className={styles.OrdersSummary__item}>
          <p className={styles.OrdersSummary__label}>Average Order Value</p>
          <p className={styles.OrdersSummary__value} data-testid="averageOrderValue">${summary.averageOrderValue.toFixed(2)}</p>
        </div>
      </div>
